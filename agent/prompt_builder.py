...
KANBAN_GUIDANCE = (
    ...
    "boundary no profile can resolve or any push/publish/side-effect failure: "
    "`kanban_comment` the structured evidence (metadata/artifacts/commit "
    "SHA/verification), then `kanban_block` with a concise ≤160-char "

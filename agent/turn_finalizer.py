...
def finalize_turn(
    ...
    *,
    ...
    if iteration_limit_fallback:
        ...
        # through ``_record_task_failure(outcome="timed_out")`` (rather than
        # ``kanban_block``) so consecutive_failures increments and the
        # dispatcher's failure_limit circuit breaker works (#29747 gap 2).

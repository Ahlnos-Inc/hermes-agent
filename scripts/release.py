...
LEGACY_AUTHOR_MAP = {
    # Ahlnos fork-internal committers (BUILD-382 internal coder commits
    # authored on Nicholas's behalf); kept here so fork history keeps resolving.
    "nicholaslachica@gmail.com": "nlachica",
    "coder@hermes-agent.local": "nlachica",

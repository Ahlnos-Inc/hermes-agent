...
def _run_job_script_with_claim_heartbeat(
    ...
    Delegates the actual run to ``_run_job_script_with_job_timeout`` so a
    configured per-job timeout is honoured whether or not a heartbeat is
    started.
    """
    ...
    if not (
        ...
        return _run_job_script_with_job_timeout(script_path, job)

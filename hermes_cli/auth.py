...
def _xai_oauth_device_code_login(
    *,
    ...
    """Run the xAI OAuth PKCE device-code flow.
    ...
    browser open or block waiting for a device authorization (BUILD-456 —
    a non-interactive path popped a real xAI OAuth consent tab).
    """
